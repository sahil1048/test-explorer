        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/50 backdrop-blur-sm animate-in fade-in duration-200">
          <div className="bg-white rounded-2xl shadow-2xl max-w-md w-full p-6 scale-100 animate-in zoom-in-95 duration-200">
            ...
            <p className="text-gray-600 mb-6 leading-relaxed">
              Are you sure you want to delete this school? This action will remove all associated data, including students and settings. <span className="font-bold text-red-600">This cannot be undone.</span>
            </p>
